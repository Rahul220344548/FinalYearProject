...
class StaffSchedulesAdapter ( private var classList : List<NewSchedule>) :
    RecyclerView.Adapter<StaffSchedulesAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, StaffScheduleInfoActivity::class.java).apply {
